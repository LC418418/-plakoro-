...
const CORE_FILES = ['./', './index.html', './manifest.webmanifest',
                    ...
                    /* 呢幾個一開機就要，所以裝嗰陣就落定。
                       ...
                       ⚠ 封面拆咗三層（背景 + 前後排角色，見 tools/splittitle.py），
                         三張都要落，唔係角色會遲一步先出現。原本嗰張
                         bg-title-v1.webp 仲留喺 repo（拆層嘅原材料）但頁面
                         已經唔用，所以唔好再 precache 佢。 */
                    './assets/dexspr-gen1-v1.js',
                    './assets/bg-title-bg-v1.webp',
                    './assets/bg-title-chb-v1.webp',
                    './assets/bg-title-chf-v1.webp'];
