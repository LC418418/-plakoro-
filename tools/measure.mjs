...
/* 八館改版之後嘅目標範圍（見 docs/八館改版計劃.md 階段 2）。
   困難喺階段 2 調到八章全部入範圍；魔鬼未調過（計劃書講明階段 2 唔理魔鬼）。
   ⚠ 局數開細（<3000）嘅話後尾幾章樣本得幾十局，上落十幾點都係正常噪音，
     唔好見到差幾點就走去改數。要落決定就開 6000 起跳。 */
console.log(DIFF === 1
  ? '\n目標（魔鬼・仲未調）：第 1-2 館 35-50 / 第 3-5 館 25-40 / 第 6-8 館 20-35 / 四天王 ≤50'
