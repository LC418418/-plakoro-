...
/* 八館改版之後嘅目標範圍（見 docs/八館改版計劃.md 階段 2）。
   ⚠ 階段 1 淨係改結構，冇調過平衡，所以而家啲數唔會入到呢個範圍，正常。 */
console.log(DIFF === 1
  ? '\n目標（魔鬼・階段 2 先調）：第 1-2 館 35-50 / 第 3-5 館 25-40 / 第 6-8 館 20-35 / 四天王 ≤50'
  : '\n目標（困難・階段 2 先調）：第 1-2 館 55-70 / 第 3-5 館 45-60 / 第 6-8 館 40-55 / 四天王 ≤50');
