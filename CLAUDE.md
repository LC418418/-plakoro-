...
- **困難後半（第 5-8 館）出咗 band**：v41 加咗「打低對手一隻免費換人」同道具袋之後，
  由 57/47/55/40 升到 **69/63/63/62**（目標 45-60 / 40-55 ×3）。頭四章冇郁、
  魔鬼喺雜訊範圍。呢個係設計上要求「加強續戰力」嘅直接後果，唔係 bug ——
  想收返就郁 `ACT_TUNE.hp` 第 5-8 格（唔好郁 `dmg`）。數據見 `tools/README.md`。
